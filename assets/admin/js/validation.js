        ...
        var project_form = function() {
            ...
            form2.validate({
                ...
                messages: {
                    ...
                    code: {
                        required: jQuery.validator.format("Enter project code.")
                    },
                    cust_name: {
                        required: jQuery.validator.format("Enter customer name.")
                    },
                    description: {
                        required: jQuery.validator.format("Enter project description.")
                    },
                    status: {
                        required: jQuery.validator.format("Please select status.")
                    }
        ...
        var create_service_form = function() {
            ...
            form2.validate({
                ...
                messages: {
                    ...
                    service_title: {
                        required: jQuery.validator.format("Enter your service title.")
                    },
                    start_date: {
                    ...
                    "vehicles[]": {
                        required: jQuery.validator.format("Select vehicle.")
                    },
                    department: {
                    ...
                    service_desc: {
                        required: jQuery.validator.format("Please enter service description ")
                    }
                },
                rules: {
