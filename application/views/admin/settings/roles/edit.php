            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <form action="" method="post" id="role_form"  class="form-horizontal" enctype="multipart/form-data" novalidate="novalidate">
                            <div class="form-body">
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" value="<?php echo $role->title; ?>" name="role_title" maxlength="50" id="first_name" data-required="1" />
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <textarea class="form-control" name="description" maxlength="500" id="description"><?php echo $role->description; ?></textarea>
                                                        ...
                                                        <?php
                                                            if(count($menus) > 0){
                                                                ...
                                                                foreach ($menus as $menu) {
                                                                    ...
                                                                    $check = in_array($menu->id, $permissions) ? 'true' : 'false';
                                                                    
                                                                    ?>
                                                                    <li data-jstree='{ "module_id" : <?php echo $menu->id; ?>, "opened" : true, "selected" : <?php echo $check; ?> }'> <?php echo $menu->display_name; ?>

                                                                        <?php
                                                                        if(count($menu->sub_menus) > 0){
                                                                            echo '<ul>';
                                                                                foreach($menu->sub_menus as $sub){
                                                                                    $checked = in_array($sub->id, $permissions) ? 'true' : 'false';
                                                                                    ?>
                                                                                    <li data-jstree='{ "module_id" : <?php echo $sub->id; ?>, "selected" : <?php echo $checked; ?> }'> <?php echo $sub->display_name; ?></li>
                                                                                    <?php
                                                                                }
                                                                            echo '</ul>';
                                                                        }
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-icon right">
                                            ...
                                            <?php
                                                ...
                                                echo form_dropdown('status', $options, $role->status, 'class="form-control" id="status" data-required="1"');
                                            ?>
