                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" name="regn_number" maxlength="100" id="regn_number" data-required="1" value='<?php echo $details->regn_number; ?>' />
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" name="model" maxlength="100" id="model" data-required="1" value='<?php echo $details->model; ?>' />
