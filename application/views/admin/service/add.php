                    ...
                    <div class="portlet-body">
                        ...
                        <form action="<?php echo site_url('admin/service/add'); ?>" method="post" id="create_service_form"  class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <input type="text" class="form-control" value="<?php echo set_value('service_title'); ?>" name="service_title" maxlength="100" id="service_title" data-required="1" />
                                ...
                                <div class="form-group  margin-top-20">
                                    <label class="control-label col-md-3">Contract/Project
                                        <span class="required"> * </span>
                                    </label>
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div id="veh_dropdown" class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <?php
                                                $options = array();
                                                ...
                                                if(is_array($vehicles)){
                                                    ...
                                                    foreach ($vehicles as $row){
                                                        ...
                                                        if($row->status == 'active'){
                                                            ...
                                                            $options[$row->id] = $row->model.' ( '.$row->regn_number.' )';
                                                        }
                                                    }
                                                }
                                ...
                                <div class="form-group  margin-top-20">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                            <i class="fa"></i>
                                            <textarea class="form-control" rows="5" id="service_desc" name="service_desc"><?php echo set_value('service_desc'); ?></textarea>
