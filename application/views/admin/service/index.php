            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <div class="btn-group">
                                <button onClick="location.href = '<?php echo site_url('admin/service/calendar'); ?>'" class="btn sbold blue">Availability Calendar</button>
                            </div>
                            <div class="btn-group">
                                <button onClick="location.href = '<?php echo site_url('admin/service/add'); ?>'" id="sample_editable_1_new" class="btn sbold green"> Add Service
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_services">
                                <thead>
                                    ...
                                    <tr class="filter" role="row">
                                        ...
                                        <td rowspan="1" colspan="1">
                                            <div class="margin-bottom-5">
                                                <input type="text" placeholder="Project Code" name="filter_project_code" class="form-control form-filter input-sm"> </div>
                                        </td>
                                        <td rowspan="1" colspan="1">
        ...
        var handleDemo = function () {
            ...
            grid.init({
                ...
                dataTable: {
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('admin/service/service_ajax'); ?>", // ajax source
                    },
                    "order": [
                        [1, "asc"]
