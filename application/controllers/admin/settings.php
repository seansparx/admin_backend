    ...
    public function admin_ajax()
    {
            ...
            if(is_array($services)) {
                ...
                foreach ($services as $row){
                    ...
                    $records["data"][] = array($chkbox, $image, $row->role_title, $row->username, $row->first_name, $row->last_name, $row->emailId, $status, display_datetime($row->addDate), $actions);
                }
            }
    ...
    public function role_ajax()
    {
            ...
            if(is_array($services)) {
                ...
                foreach ($services as $row){
                    ...
                    $records["data"][] = array($chkbox, $row->title, $row->description, $row->status, display_datetime($row->created_at), $actions);
                }
            }
