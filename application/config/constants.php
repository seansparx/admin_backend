...
$site_url='http://10.0.4.4/CSS5811/';
$site_dir=SITE_DIR."/";

//$domain ='http://projects.thesparxitsolutions.com/';
//define('OAUTHDOMAIN', $domain);
//define('SITE_DIR',realpath(''));
//$site_url='http://projects.thesparxitsolutions.com/CSS5515/';
//$site_dir=SITE_DIR."/";
...
//define('VARIANT_BANNER_AREA',1);
//define('VARIANT_FORM_AREA',2);
//define('VARIANT_STEP_AREA', 3);
//define('VARIANT_ABOUT_AREA', 4);
//define('VARIANT_COMPARE_AREA', 5);
//define('VARIANT_TESTIMONIAL_AREA', 6);
//define('VARIANT_FORM2_AREA', 7);
