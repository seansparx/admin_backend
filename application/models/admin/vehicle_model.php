...
class Vehicle_model extends CI_Model {
    ...
    {
        $query = $this->db->query("SELECT a.service_id FROM ".TBL_SERVICE_DETAILS." AS a LEFT JOIN ".TBL_SERVICE." AS b ON(b.id = a.service_id) WHERE b.deleted_at IS NULL AND find_in_set(".$vehicle_id.",vehicle_id) GROUP BY service_id");
